...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const MapWidget() : const LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'payment3',
          path: '/payment3',
          builder: (context, params) => const Payment3Widget(),
        ),
        FFRoute(
          name: 'SignUp',
          path: '/signUp',
        ...
        FFRoute(
          name: 'TicketHistory',
          path: '/ticketHistory',
          builder: (context, params) => const TicketHistoryWidget(),
        )
