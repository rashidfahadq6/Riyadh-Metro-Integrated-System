...
class _SignUpWidgetState extends State<SignUpWidget>
  ...
  void initState() {
    ...
    _model.passwordConfirmFieldTextController ??= TextEditingController();
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'pvk9usbm' /* Create an account by using the... */,
                                ),
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.passwordConfirmFieldTextController,
                                  focusNode:
                                      _model.passwordConfirmFieldFocusNode,
                                  autofocus: true,
                                  autofillHints: const [AutofillHints.password],
                                  obscureText:
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon: InkWell(
                                      onTap: () => safeSetState(
                                        () => _model
                                                .passwordConfirmFieldVisibility =
                                            !_model
                                                .passwordConfirmFieldVisibility,
                                      ),
                                      focusNode: FocusNode(skipTraversal: true),
                                ...
                                onPressed: () async {
                                  try {
                                    if (_model
                                        ...
                                        _model
                                            .passwordConfirmFieldTextController
                                            .text) {
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'lb197smm' /* Already have an account?  */,
                                          ),
